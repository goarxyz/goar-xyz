...
|---|---|
| Rootfs installer | Accepts valid literal-backslash Linux filenames such as Kali systemd `\\x2d` unit names while retaining canonical path-containment checks against traversal. |
...
| Asset | SHA-256 | Size |
|---|---|---:|
| `goar-os-v1.2.0-arm64-v8a.apk` | `c704dc04e5711c5fbedb2bbcdfb0dde78348db4ed13bea6b3c202967bcc202a6` | 184,509 bytes |
