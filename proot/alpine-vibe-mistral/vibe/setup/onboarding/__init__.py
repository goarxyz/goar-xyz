...
class OnboardingApp(App[str | None]):
    ...
    async def persist_credentials(self, api_key: str) -> str:
        """Persist explicitly supplied credentials without account discovery."""
        ...
        # Privacy fork: retain the endpoint selected during onboarding and do not
        # send a follow-up account or tenant-discovery request.
