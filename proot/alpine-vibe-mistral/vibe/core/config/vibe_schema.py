...
class VibeConfigSchema(ConfigSchema):
    ...
    # Privacy fork: analytics are removed and the compatibility client is always local-only.
    enable_telemetry: Annotated[bool, WithReplaceMerge()] = False
    ...
    # Privacy fork: no automatic network checks or self-updates are performed.
    enable_update_checks: Annotated[bool, WithReplaceMerge()] = False
    enable_auto_update: Annotated[bool, WithReplaceMerge()] = False
