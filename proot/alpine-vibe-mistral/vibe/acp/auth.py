...
class AcpAuthController:
    def __init__(
        ...
        *,
        ...
        # Privacy fork: tenant discovery is disabled after explicit sign-in.
        del tenant_domain_resolver
    ...
    async def _persist_credentials(
        ...
        # Privacy fork: preserve the explicitly selected endpoint and avoid a
        # follow-up account or tenant-discovery request.
