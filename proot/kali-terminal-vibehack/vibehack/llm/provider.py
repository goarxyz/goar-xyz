...
# LiteLLM is intentionally imported on first provider request, not during TUI
# startup.  On mobile ARM64 the provider registry is substantial, while the
# operator should be able to open the terminal and inspect local state promptly.
