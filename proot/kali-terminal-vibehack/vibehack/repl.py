    ...
    async def handle_input(self, user_input: str):
        ...
        try:
            if user_input.startswith("/"):
                ...
                # Every normal agent turn is owned by GOAR's durable session facade.
                from goar_interactive import run_interactive_turn
                await run_interactive_turn(self, user_input, process_llm_turn)
