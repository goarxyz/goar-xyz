...
def _os_keyring_enabled() -> bool:
    """Desktop keyrings are unavailable in the Android PRoot guest by default."""
    return KEYRING_AVAILABLE and os.getenv("GOAR_USE_OS_KEYRING", "").lower() in {
        "1",
        "true",
        "yes",
    }
...
def set_api_key(provider: str, key: str):
    ...
    if _os_keyring_enabled() and key:
        try:
